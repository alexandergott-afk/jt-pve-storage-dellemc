...
>
> **This is a beta release (0.7.60~beta1). It has never been run against a
...
> **Version 0.7.60~beta1 — three storage types are code complete, and
...
`0.7.60~beta1-1`. Copy the exact name from the release page rather than
