...
ME4024 客戶，在 **0.7.66~beta1** 上確認的。這幾項合起來，涵蓋了沒有陣列就最難
推論的幾條路徑：客體作業系統從陣列 volume 開機、`expand volume` 那個「要增加
...
這台陣列上仍未跑過的：iSCSI、SAS、節點間的線上遷移、路徑失效，以及 0.7.88 新增
的兩條傳輸路徑。
